...
public class UI_ThongTinBangDia extends JPanel  implements ActionListener{
	DefaultTableModel modeltable;
	JTable table;
	JTextField txtTim;
	JButton btnTim, btnThem, btnSua, btnLoad, btnThoat;
	UI_KhachHang ui;
	public UI_ThongTinBangDia() {
		...
		String[] chuoi = {"Mã băng đĩa","Tên băng đĩa","thể loại","tình trạng","ghi chú","hãng sản xuất"};
...
//				}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UI_ThongTinBangDia frame = new UI_ThongTinBangDia();
...
//	private void timBD() throws SQLException{
//		dao_bangdia dao_bd= new dao_bangdia();
//		modeltable = dao_bd.timKiem("%"+txtTim.getText()+"%", "%"+txtTim.getText()+"%");
//		table.setModel(modeltable);
//	}
