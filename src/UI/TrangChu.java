...
public class TrangChu extends JPanel{
	...
	public TrangChu() {
		...
		Font fontND =new Font("Arial",Font.BOLD | Font.ITALIC,25);
		...
		JLabel lblTen  = new JLabel("Công ty băng đĩa CD IUH");
		lblTen.setForeground(Color.RED);
		lblTen.setFont(fontTen);
		
		JLabel lblNoiDung = new JLabel("<html>Trải qua nhiều năm hoạt động , CD IUH đã không ngừng phát triển nâng cao chất<BR>"
				...
				+ " đạo công ty CD IUH, luôn đem đến cho khách hàng những sản phẩm, dịch vụ đạt<BR>"
				+ " chất lượng tốt nhất với giả cả cạnh tranh.<BR> "
				+ " Sự hài lòng của quý khách luôn là tiêu chí hàng đầu của CD IUH</html>",JLabel.CENTER);
		lblNoiDung.setFont(fontND);
		lblNoiDung.setForeground(Color.YELLOW);
